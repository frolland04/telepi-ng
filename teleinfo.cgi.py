...
readTableRows( "T_TELEINFO_MIN", 5, "TS", True )
readTableRows( "T_TELEINFO_MAX", 5, "TS", True )
readTableRows( "T_TEMP_MIN", 5, "TS", True )
readTableRows( "T_TEMP_MAX", 5, "TS", True )
readTableRows( "T_RH_MIN", 5, "TS", True )
readTableRows( "T_RH_MAX", 5, "TS", True )
readTableRows( "T_PA_MIN", 5, "TS", True )
readTableRows( "T_PA_MAX", 5, "TS", True )
